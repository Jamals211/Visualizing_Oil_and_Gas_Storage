...
let overlays = {
  "Monthly Production (mBBL)": earthquakes
  };
...
function styleInfo(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
    fillColor: getColor(feature.data.Production),
    color: "#000000",
    radius: getRadius(feature.pdata.Production),
    stroke: true,
    weight: 0.5
  };
}
...
//use pointToLayer to create circleMarkers
    pointToLayer: function(feature, latlng) 
    {
        ...
        {
            layer.bindPopup(`${"Monthly Production (mBBL) :"+feature.data.Production}<br><hr>${"State: "+feature.data.PlaceName}`)
        }
    }).addTo(earthquakes);
...
legend.onAdd = function () 
{
    ...
    const magnitudes = [0, 1000, 5000, 10000, 50000, 100000];
    const colors = 
    [
      "#98ee00",
      "#d4ee00",
